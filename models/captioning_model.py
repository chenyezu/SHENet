...
class CaptioningModel(Module):
    ...
    def step(self, t, prev_output, img, obj, seq, mode='teacher_forcing', **kwargs):
        raise NotImplementedError
    ...
    def beam_search(self, img, obj, max_len: int, eos_idx: int, beam_size: int, out_size=1,
                    return_probs=False, **kwargs):
        bs = BeamSearch(self, max_len, eos_idx, beam_size)
        return bs.apply(img, obj, out_size, return_probs, **kwargs)
