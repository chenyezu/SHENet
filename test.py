...
WATCH_IMG_IDS = {1554, 999,2473,72,36}  # 改成你想看的 COCO image id, set() 则不打印
...
if __name__ == '__main__':
    ...
    parser.add_argument('--enc_layers', type=int, default=3, help='编码器块数 (SPE→OSCE→DVF 重复次数)')
